...
export async function GET(request) {
  ...
  // NOTE: users, sites, operator-assignments, staff-assignments, field-configs,
  // banking-formulas paths are intercepted by modular routes — never reach here.
...
export async function POST(request) {
  ...
  // NOTE: users, sites, operator-assignments, staff-assignments are
  // intercepted by modular routes — never reach here for those paths.
  if (path[0] === 'reports' || path[0] === 'form-submissions') {
...
export async function PUT(request) {
  ...
  // NOTE: users, sites, field-configs, banking-formulas PUTs go through
  // modular routes — never reach here.
...
export async function DELETE(request) {
  ...
  // NOTE: users, sites, operator-assignments, staff-assignments,
  // field-configs, banking-formulas DELETEs go through modular routes.
