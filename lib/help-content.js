...
export const CHANGELOG = [
  {
    date: '2026-06-14',
    title: 'Flat-design sweep — all gradients removed',
    body:
      'Every screen in the app has been re-skinned with a flat, teal-aligned design language. Stat cards use a left-border accent + tinted panel, buttons use solid teal/red/emerald, and the marketing/landing page is the only place gradients still live.',
    tags: ['ui', 'design'],
  },
  {
    date: '2026-06-12',
    title: 'Operator + Staff dashboard upgrades',
    body:
      'Operators now see a wet-stock alerts banner, a quick-actions strip, a teal-aligned KPI row, and a "My Team" panel showing who submitted what and when. Staff get a "Today at a glance" card with auto-detected shift, plus a "My recent reports" list with status pills. The mobile-first shift report wizard is now the default form.',
    tags: ['operator', 'staff', 'ui'],
  },
  {
    date: '2026-06-10',
    title: 'Fuel margin per litre (P2b)',
    body:
      'Owners on the Growth and Enterprise plans now see gross margin per litre by grade, computed with a moving weighted-average cost (so it self-heals when delivery costs change). Operators log fuel deliveries with total $ cost; the engine derives the unit cost and reconciles it against sales.',
    tags: ['fuel-margin', 'subscription', 'p2b'],
  },
  {
    date: '2026-06-08',
    title: 'Wet-stock reconciliation (P2a)',
    body:
      'A new Wet-stock tab compares book stock (deliveries − sales) against measured dips per grade per site. Sites drift past tolerance are flagged red/amber on the Operator dashboard, with a one-click jump to the full reconciliation view.',
    tags: ['wetstock', 'fuel', 'p2a'],
  },
  {
    date: '2026-06-06',
    title: 'Stripe subscriptions are live',
    body:
      'Owners can now self-serve Starter / Growth / Enterprise plans via Stripe Checkout, manage cards / cancel / pause from the Customer Portal, and gated features (like fuel margin) unlock instantly via webhook. Operators inherit their owner\'s plan automatically.',
    tags: ['billing', 'stripe'],
  },
  {
    date: '2026-06-04',
    title: 'Financial integrity layer (P1)',
    body:
      'A canonical set of formulas now backs every revenue, banking, and variance number across the app. A new Data Integrity tab on the Owner dashboard surfaces any cross-checks that don\'t match — orphan deliveries, fuel price outliers, banking-vs-reports mismatches.',
    tags: ['data-integrity', 'p1'],
  },
  {
    date: '2026-05-29',
