...
const METRIC_FNS = {
  revenue:     (r) => Number(r.total_revenue) || Number(r.total_sales) || 0,
  fuel_sales:  (r) => Number(r.fuel_sales) || 0,
  shop_sales:  (r) => Number(r.shop_sales) || 0,
  litres:      (r) => Number(r.total_litres) || 0,
  banking:     (r) => (Number(r.eftpos) || 0) + (Number(r.motorpass) || 0) + (Number(r.cash) || 0) + (Number(r.accounts) || 0),
