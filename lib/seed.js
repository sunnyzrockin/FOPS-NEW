...
export function generateSiteAssignments(users, sites) {
  ...
  // Staff assignments (assigned by operators)
  // Staff 1, 2 -> Site 1 (Brisbane) - assigned by Operator 1
  assignments.push({ id: uuidv4(), user_id: staff[0].id, site_id: sites[0].id, assigned_by_user_id: operators[0].id, created_at: new Date().toISOString() });
  assignments.push({ id: uuidv4(), user_id: staff[1].id, site_id: sites[0].id, assigned_by_user_id: operators[0].id, created_at: new Date().toISOString() });
  
  // Staff 2, 3 -> Site 2 (Gold Coast) - assigned by Operator 1
  assignments.push({ id: uuidv4(), user_id: staff[1].id, site_id: sites[1].id, assigned_by_user_id: operators[0].id, created_at: new Date().toISOString() });
  assignments.push({ id: uuidv4(), user_id: staff[2].id, site_id: sites[1].id, assigned_by_user_id: operators[0].id, created_at: new Date().toISOString() });
  
  // Staff 3 -> Site 3 (Sunshine Coast) - assigned by Operator 1
  assignments.push({ id: uuidv4(), user_id: staff[2].id, site_id: sites[2].id, assigned_by_user_id: operators[0].id, created_at: new Date().toISOString() });
  
  // Staff 4, 5 -> Site 4 (Toowoomba) - assigned by Operator 2
  assignments.push({ id: uuidv4(), user_id: staff[3].id, site_id: sites[3].id, assigned_by_user_id: operators[1].id, created_at: new Date().toISOString() });
  assignments.push({ id: uuidv4(), user_id: staff[4].id, site_id: sites[3].id, assigned_by_user_id: operators[1].id, created_at: new Date().toISOString() });
  
  // Staff 5, 6 -> Site 5 (Cairns) - assigned by Operator 2
  assignments.push({ id: uuidv4(), user_id: staff[4].id, site_id: sites[4].id, assigned_by_user_id: operators[1].id, created_at: new Date().toISOString() });
  assignments.push({ id: uuidv4(), user_id: staff[5].id, site_id: sites[4].id, assigned_by_user_id: operators[1].id, created_at: new Date().toISOString() });
